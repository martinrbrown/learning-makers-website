...
export default function sitemap(): MetadataRoute.Sitemap {
  const staticPages: MetadataRoute.Sitemap = [
    ...
    { url: `${BASE_URL}/articles`, lastModified: TODAY, changeFrequency: 'weekly', priority: 0.6 },
    { url: `${BASE_URL}/articles/why-every-instructional-designer-should-consider-cpacc`, lastModified: TODAY, changeFrequency: 'monthly', priority: 0.6 },
