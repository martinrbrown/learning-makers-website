...
export default function GuideReader({
  ...
  const firstPageSlug = firstPageHref.slice(guidePath.length + 1);
  ...
  function handleSearch(e: React.FormEvent<HTMLFormElement>) {
    ...
    if (!q) return;
    router.push(`${guidePath}/search?q=${encodeURIComponent(q)}`);
  }
