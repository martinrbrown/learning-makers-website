...
export const metadata: Metadata = {
  ...
  description:
    'The CPACC Quick Guide covers the full IAAP Body of Knowledge in plain language — a free resource for CPACC candidates and anyone building foundational accessibility knowledge.',
}
        ...
        <div className="container">
          <div className={styles.pageHeroInner}>
            <div className={styles.heroText}>
              ...
              <h1 className={styles.title}>CPACC Quick Guide</h1>
            </div>
            <Image
      ...
      <div className={styles.content}>
        <div className="container">
          <div className={styles.prose}>
            ...
            <p>
              The CPACC Quick Guide covers the full IAAP Body of Knowledge in plain language.
